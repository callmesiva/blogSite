      ...
      <section className="hero-grid">
        <ScrollReveal className="site-container pb-14 pt-12 lg:pb-20 lg:pt-16 flex flex-col items-center text-center">
          ...
          <h1 className="mt-4 max-w-[920px]">
            Good work <AnimatedUnderline>starts</AnimatedUnderline> with an
            honest conversation
          </h1>
      ...
      <section className="site-section font-['DM_Sans',sans-serif]">
        <ScrollReveal className="site-container">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-stretch">
            ...
            {/* ── RIGHT CARD ── */}
            <div
              className={`relative flex flex-col h-[480px] max-h-[480px] rounded-[28px] sm:rounded-[34px] border-[0.5px] border-[#e2e2e0] bg-[#f4f4f2] animate-[cardReveal_0.7s_0.15s_cubic-bezier(0.22,1,0.36,1)_both] box-border transition-all duration-500 ease-in-out`}
            >
              <div
                className={`absolute inset-0 flex flex-col items-center justify-center p-8 sm:p-10 gap-5 transition-[opacity,visibility] duration-300 z-10`}
              >
